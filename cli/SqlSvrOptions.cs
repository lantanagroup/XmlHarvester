...
{
    [Verb("mssql", HelpText = "Store data from XML files in a SQL Server database")]
    internal class SqlSvrOptions
    {
        ...
        [Option('v', "server", Required = false, HelpText = "The name of the sql server", Default = "localhost")]
        public string Server { get; set; }
		
        [Option('d', "database", Required = false, HelpText = "The name of the database to convert/output to.", Default = "harvester")]
